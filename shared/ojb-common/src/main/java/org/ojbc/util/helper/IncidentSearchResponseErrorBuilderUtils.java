...
public class IncidentSearchResponseErrorBuilderUtils {
	private static final OjbcNamespaceContext OJBC_NAMESPACE_CONTEXT = new OjbcNamespaceContext();
	
	public static Document createIncidentSearchAccessDenial(AccessControlResponse accessControlResponse, String denyingSystem) throws Exception
	{
		Document doc = null;
        ...
        Element root = doc.createElementNS(OjbcNamespaceContext.NS_INCIDENT_SEARCH_RESULTS_DOC, "IncidentSearchResults");
        doc.appendChild(root);
        root.setPrefix(OjbcNamespaceContext.NS_PREFIX_INCIDENT_SEARCH_RESULTS_DOC);
