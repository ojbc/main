...
public class VehicleCrashResponseNullObjectProcessor extends AbstractVehicleCrashQueryResponseProcessor{

	private static final Log log = LogFactory.getLog(VehicleCrashResponseNullObjectProcessor.class);
