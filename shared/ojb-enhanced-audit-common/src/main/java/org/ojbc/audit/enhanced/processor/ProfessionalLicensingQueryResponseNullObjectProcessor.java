...
public class ProfessionalLicensingQueryResponseNullObjectProcessor extends AbstractProfessionalLicensingQueryResponseProcessor{

	private static final Log log = LogFactory.getLog(ProfessionalLicensingQueryResponseNullObjectProcessor.class);
