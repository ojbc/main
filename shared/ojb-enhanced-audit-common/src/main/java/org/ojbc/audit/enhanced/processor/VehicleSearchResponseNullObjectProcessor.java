...
public class VehicleSearchResponseNullObjectProcessor extends AbstractVehicleSearchResponseProcessor{

	private static final Log log = LogFactory.getLog(VehicleSearchResponseNullObjectProcessor.class);
