...
public class IdentificationSearchResponseNullObjectProcessor extends AbstractIdentificationSearchResponseProcessor {

	private static final Log log = LogFactory.getLog(IdentificationSearchResponseNullObjectProcessor.class);
	
	private UserInfoNullObjectProcessor userInfoProcessor;
	
	public void auditIdentificationSearchResponse(Document document, String messageID)
	{
		try {
