...
public class VehicleSearchRequestNullObjectProcessor extends AbstractVehicleSearchRequestProcessor {

	private static final Log log = LogFactory.getLog(VehicleSearchRequestNullObjectProcessor.class);
