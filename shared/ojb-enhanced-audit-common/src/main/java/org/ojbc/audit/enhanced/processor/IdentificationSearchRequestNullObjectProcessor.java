...
public class IdentificationSearchRequestNullObjectProcessor extends AbstractIdentificationSearchRequestProcessor {

	private static final Log log = LogFactory.getLog(IdentificationSearchRequestNullObjectProcessor.class);
	...
	public void auditIdentificationSearchRequest(Exchange exchange, @Body Document document)
	{
		try {
			...
			e.printStackTrace();
			log.error("Unable to audit identification search request: " + ExceptionUtils.getStackTrace(e));
		}
