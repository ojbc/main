...
public class IncidentSearchResponseNullObjectProcessor extends AbstractIncidentSearchResponseProcessor{

	private static final Log log = LogFactory.getLog(IncidentSearchResponseNullObjectProcessor.class);
	...
	public void auditIncidentSearchResponse(@Body Document document,  @Header(value = "federatedQueryRequestGUID")String messageID) {
		...
		try {
			...
			e.printStackTrace();
			log.error("Unable to audit incident search response: " + ExceptionUtils.getStackTrace(e));
		}
