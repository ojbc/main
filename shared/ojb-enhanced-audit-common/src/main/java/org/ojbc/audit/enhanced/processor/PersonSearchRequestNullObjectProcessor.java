...
public class PersonSearchRequestNullObjectProcessor extends AbstractPersonSearchRequestProcessor {

	private static final Log log = LogFactory.getLog(PersonSearchRequestNullObjectProcessor.class);
