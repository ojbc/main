...
public abstract class AbstractSubscriptionSearchRequestProcessor {
	...
	SubscriptionSearchRequest processSubscriptionSearchRequest(Document document) throws Exception
	{
		SubscriptionSearchRequest subscriptionSearchRequest = SubscriptionSearchRequestUtils.parseSubscriptionSearchRequest(document);
