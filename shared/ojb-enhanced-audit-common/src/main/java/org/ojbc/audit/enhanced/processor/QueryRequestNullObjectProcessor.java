...
public class QueryRequestNullObjectProcessor extends AbstractQueryRequestProcessor {

	private static final Log log = LogFactory.getLog(QueryRequestNullObjectProcessor.class);
