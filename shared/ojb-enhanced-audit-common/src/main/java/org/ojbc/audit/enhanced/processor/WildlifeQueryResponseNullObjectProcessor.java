...
public class WildlifeQueryResponseNullObjectProcessor extends AbstractWildlifeQueryResponseProcessor{

	private static final Log log = LogFactory.getLog(WildlifeQueryResponseNullObjectProcessor.class);
