...
import org.ojbc.util.model.person.SearchFieldMetadata;
...
public class NIEMXMLUtils {
	...
	//	</SearchMetadata>
	public static Element createFirearmSearchMetaData(Document doc, String searchFieldMetaDataNamespace, org.ojbc.util.model.firearm.SearchFieldMetadata searchFieldMetadata)
	{
		Element searchFieldMetadataElement = doc.createElementNS(searchFieldMetaDataNamespace, "SearchMetadata");
		
		if (searchFieldMetadata == org.ojbc.util.model.firearm.SearchFieldMetadata.ExactMatch)
		{	
			searchFieldMetadataElement.setAttributeNS(NIEMNamespaces.STRUCT_NS, "id", "SM001");
		}	

		if (searchFieldMetadata == org.ojbc.util.model.firearm.SearchFieldMetadata.Partial)
		{	
			searchFieldMetadataElement.setAttributeNS(NIEMNamespaces.STRUCT_NS, "id", "SM002");
		}	
