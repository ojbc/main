...
public class OJBCWebServiceURIs {
	...
	public static final String WILDLIFE_LICENSING = "{http://ojbc.org/Services/WSDL/Person_Query_Service-Vehicle_Crash/1.0}Person-Query-Service---Wildlife-Licensing";
