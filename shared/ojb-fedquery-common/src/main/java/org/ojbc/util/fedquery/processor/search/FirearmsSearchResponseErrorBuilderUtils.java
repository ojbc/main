...
public class FirearmsSearchResponseErrorBuilderUtils {

	private static final OjbcNamespaceContext OJBC_NAMESPACE_CONTEXT = new OjbcNamespaceContext();
	
	public static Document createFirearmsSearchAccessDenial(AccessControlResponse accessControlResponse, String denyingSystem) throws Exception
	{
		Document doc = null;
        ...
        Element root = doc.createElementNS(OjbcNamespaceContext.NS_FIREARM_SEARCH_RESULT_DOC, "FirearmSearchResults");
        doc.appendChild(root);
        root.setPrefix(OjbcNamespaceContext.NS_PREFIX_FIREARM_SEARCH_RESULT_DOC);
