...
DROP SCHEMA IF EXISTS consent_management CASCADE;
CREATE SCHEMA consent_management;
SET SCHEMA consent_management;
USE consent_management; 

-- Create the consent_decision_type table
CREATE TABLE consent_decision_type (
    ConsentDecisionTypeID INT GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
    ConsentDecisionDescription VARCHAR(25) NOT NULL
);

-- Create the consent_decision table
CREATE TABLE consent_decision (
    ConsentDecisionID INT GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
    ConsentDecisionTypeID INT,
...
ALTER TABLE consent_decision
ADD CONSTRAINT fk_consent_decision_type
