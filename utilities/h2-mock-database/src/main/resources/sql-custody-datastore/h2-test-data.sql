...
INSERT INTO booking(person_id, booking_number, booking_datetime, facility, booking_photo, actual_release_datetime, commit_date, scheduled_release_date, block, bed, cell, case_status, inmate_work_release_indicator, inmate_worker_indicator, probationer_indicator, incarcerated_indicator) values
