 ...
 */
DROP SCHEMA IF EXISTS custody_datastore CASCADE;
...
CREATE TABLE person_alias (
    ...
    alias_sex VARCHAR(1),
    alias_dob DATE,
    CONSTRAINT person_alias_pk PRIMARY KEY (id)
);
...
CREATE TABLE booking (
    ...
    facility VARCHAR(50),
    booking_photo BINARY VARYING(100),
...
ALTER TABLE booking ADD CONSTRAINT booking_person_fk
FOREIGN KEY (person_id)
REFERENCES person (id)
ON DELETE CASCADE;

ALTER TABLE person_alias ADD CONSTRAINT alias_person_fk
FOREIGN KEY (person_id)
REFERENCES person (id)
ON DELETE CASCADE;

ALTER TABLE scars_marks_tattoos ADD CONSTRAINT smt_person_fk
FOREIGN KEY (person_id)
REFERENCES person (id)
ON DELETE CASCADE;

ALTER TABLE conditions ADD CONSTRAINT conditions_person_fk
FOREIGN KEY (person_id)
REFERENCES person (id)
ON DELETE CASCADE;

ALTER TABLE arrest ADD CONSTRAINT arrest_booking_fk
FOREIGN KEY (booking_id)
REFERENCES booking (id)
ON DELETE CASCADE;

ALTER TABLE location ADD CONSTRAINT location_arrest_fk
FOREIGN KEY (arrest_id)
REFERENCES arrest (id)
ON DELETE CASCADE;

ALTER TABLE charge ADD CONSTRAINT charge_arrest_fk
FOREIGN KEY (arrest_id)
REFERENCES arrest (id)
ON DELETE CASCADE;
