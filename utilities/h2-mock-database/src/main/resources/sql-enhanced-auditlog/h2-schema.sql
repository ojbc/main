...
CREATE TABLE INCIDENT_SEARCH_RESULTS (
                INCIDENT_SEARCH_RESULTS_ID IDENTITY NOT NULL,
                ...
                SEARCH_RESULTS_TIMEOUT_INDICATOR BOOLEAN,
                TIMESTAMP TIMESTAMP DEFAULT CURRENT_TIMESTAMP() NOT NULL,
                CONSTRAINT INCIDENT_SEARCH_RESULTS_ID PRIMARY KEY (INCIDENT_SEARCH_RESULTS_ID)
);
...
CREATE TABLE VEHICLE_SEARCH_RESULTS (
                VEHICLE_SEARCH_RESULTS_ID IDENTITY NOT NULL,
                ...
                SEARCH_RESULTS_TIMEOUT_INDICATOR BOOLEAN,
                TIMESTAMP TIMESTAMP DEFAULT CURRENT_TIMESTAMP() NOT NULL,
                CONSTRAINT VEHICLE_SEARCH_RESULTS_ID PRIMARY KEY (VEHICLE_SEARCH_RESULTS_ID)
);
...
CREATE TABLE CANNABIS_LICENSING_QUERY_RESULTS (
                CANNABIS_LICENSING_QUERY_RESULTS_ID IDENTITY NOT NULL,
                ...
                TIMESTAMP TIMESTAMP DEFAULT CURRENT_TIMESTAMP() NOT NULL,
                CONSTRAINT CANNABIS_LICENSING_QUERY_RESULTS_ID PRIMARY KEY (CANNABIS_LICENSING_QUERY_RESULTS_ID)
);
