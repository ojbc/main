...
INSERT into FEDERAL_RAPBACK_SUBSCRIPTION 
	(FEDERAL_RAPBACK_SUBSCRIPTION_ID, TRANSACTION_CONTROL_REFERENCE_IDENTIFICATION, TRANSACTION_CATEGORY_CODE_REQUEST, TRANSACTION_CATEGORY_CODE_RESPONSE, PATH_TO_REQUEST_FILE, PATH_TO_RESPONSE_FILE,
	SUBSCRIPTION_CATEGORY_CODE, STATE_SUBSCRIPTION_ID, FBI_SUBSCRIPTION_ID, SID, TRANSACTION_STATUS_TEXT, REQUEST_SENT_TIMESTAMP, RESPONSE_RECIEVED_TIMESTAMP)
	values (2, '59c4496305b342b79aebca21e85f6250', 'RBSCRM', 'RBSR', '/tmp/ojb/adapter/FbiEbts/output/fbiSubscriptions/requests/FBI_Subscription_Request_59c4496305b342b79aebca21e85f6250.xml'
