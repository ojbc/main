...
CREATE TABLE FEDERAL_RAPBACK_NOTIFICATION_ERRORS (
                FEDERAL_RAPBACK_NOTIFICATION_ERRORS_ID INT AUTO_INCREMENT NOT NULL,
                FEDERAL_RAPBACK_NOTIFICATION_ID INT NOT NULL,
                STATE_SUBSCRIPTION_ID VARCHAR(20),
                ERROR_REPORTED BOOLEAN,
                ERROR_RESOLVED BOOLEAN,
                PRIMARY KEY (FEDERAL_RAPBACK_NOTIFICATION_ERRORS_ID)
);
...
ALTER TABLE FEDERAL_RAPBACK_NOTIFICATION_ERRORS ADD CONSTRAINT frn_frn_errors_fk
FOREIGN KEY (FEDERAL_RAPBACK_NOTIFICATION_ID)
REFERENCES FEDERAL_RAPBACK_NOTIFICATION (FEDERAL_RAPBACK_NOTIFICATION_ID)
ON DELETE NO ACTION
ON UPDATE NO ACTION;
