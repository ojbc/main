...
CREATE TABLE SUBSCRIPTION_REASON_CODE (
                SUBSCRIPTION_REASON_CODE_ID INT AUTO_INCREMENT NOT NULL,
                SUBSCRIPTION_REASON_CODE VARCHAR(100) NOT NULL,
                PRIMARY KEY (SUBSCRIPTION_REASON_CODE_ID)
);


CREATE TABLE SUBSCRIPTION_SEARCH_REQUEST (
                SUBSCRIPTION_SEARCH_REQUEST_ID INT AUTO_INCREMENT NOT NULL,
                ...
                PRIMARY KEY (SUBSCRIPTION_SEARCH_REQUEST_ID)
);


CREATE TABLE SUBSCRIPTION_REASON_CODE_JOINER (
                SUBSCRIPTION_REASON_CODE_JOINER INT AUTO_INCREMENT NOT NULL,
                SUBSCRIPTION_SEARCH_REQUEST_ID INT NOT NULL,
                SUBSCRIPTION_REASON_CODE_ID INT NOT NULL,
                PRIMARY KEY (SUBSCRIPTION_REASON_CODE_JOINER)
);


CREATE TABLE SUBSCRIPTION_SEARCH_RESULTS (
                SUBSCRIPTION_SEARCH_RESULTS_ID INT AUTO_INCREMENT NOT NULL,
                SUBSCRIPTION_SEARCH_REQUEST_ID INT NOT NULL,
                ...
                TIMESTAMP DATETIME DEFAULT CURRENT_TIMESTAMP() NOT NULL,
                PRIMARY KEY (SUBSCRIPTION_SEARCH_RESULTS_ID)
);
...
CREATE TABLE INCIDENT_SEARCH_RESULTS (
                INCIDENT_SEARCH_RESULTS_ID INT AUTO_INCREMENT NOT NULL,
                ...
                SEARCH_RESULTS_TIMEOUT_INDICATOR BOOLEAN,
                TIMESTAMP DATETIME DEFAULT CURRENT_TIMESTAMP() NOT NULL,
                PRIMARY KEY (INCIDENT_SEARCH_RESULTS_ID)
);
...
CREATE TABLE VEHICLE_SEARCH_RESULTS (
                VEHICLE_SEARCH_RESULTS_ID INT AUTO_INCREMENT NOT NULL,
                ...
                SEARCH_RESULTS_TIMEOUT_INDICATOR BOOLEAN,
                TIMESTAMP DATETIME DEFAULT CURRENT_TIMESTAMP() NOT NULL,
                PRIMARY KEY (VEHICLE_SEARCH_RESULTS_ID)
);
...
CREATE TABLE CANNABIS_LICENSING_QUERY_RESULTS (
                CANNABIS_LICENSING_QUERY_RESULTS_ID INT AUTO_INCREMENT NOT NULL,
				...
				`timestamp` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
                PRIMARY KEY (CANNABIS_LICENSING_QUERY_RESULTS_ID)
);


CREATE TABLE WILDLIFE_QUERY_RESULTS (
                WILDLIFE_QUERY_RESULTS_ID INT AUTO_INCREMENT NOT NULL,
                QUERY_REQUEST_ID INT NOT NULL,
                ...
                QUERY_RESULTS_TIMEOUT_INDICATOR BOOLEAN,
                TIMESTAMP DATETIME DEFAULT CURRENT_TIMESTAMP() NOT NULL,
                PRIMARY KEY (WILDLIFE_QUERY_RESULTS_ID)
);


CREATE TABLE INCIDENT_REPORT_QUERY_RESULTS (
                INCIDENT_REPORT_QUERY_RESULTS_ID INT AUTO_INCREMENT NOT NULL,
                QUERY_REQUEST_ID INT NOT NULL,
                ...
                QUERY_RESULTS_TIMEOUT_INDICATOR BOOLEAN,
                TIMESTAMP DATETIME DEFAULT CURRENT_TIMESTAMP() NOT NULL,
                PRIMARY KEY (INCIDENT_REPORT_QUERY_RESULTS_ID)
);


CREATE TABLE PROFESSIONAL_LICENSING_QUERY_RESULTS (
                PROFESSIONAL_LICENSING_QUERY_RESULTS_ID INT AUTO_INCREMENT NOT NULL,
                QUERY_REQUEST_ID INT NOT NULL,
                LICENSE_NUMBER VARCHAR(80),
                ...
                QUERY_RESULTS_TIMEOUT_INDICATOR BOOLEAN,
                TIMESTAMP DATETIME DEFAULT CURRENT_TIMESTAMP() NOT NULL,
                PRIMARY KEY (PROFESSIONAL_LICENSING_QUERY_RESULTS_ID)
);


CREATE TABLE VEHICLE_CRASH_QUERY_RESULTS (
                VEHICLE_CRASH_QUERY_RESULTS_ID INT AUTO_INCREMENT NOT NULL,
                QUERY_REQUEST_ID INT NOT NULL,
                SYSTEM_NAME VARCHAR(80),
                QUERY_RESULTS_ERROR_INDICATOR BOOLEAN,
                QUERY_RESULTS_ACCESS_DENIED BOOLEAN,
                ...
                QUERY_RESULTS_TIMEOUT_INDICATOR BOOLEAN,
                TIMESTAMP DATETIME DEFAULT CURRENT_TIMESTAMP() NOT NULL,
                PRIMARY KEY (VEHICLE_CRASH_QUERY_RESULTS_ID)
);


CREATE TABLE CRASH_VEHICLE (
                CRASH_VEHICLE_ID INT AUTO_INCREMENT NOT NULL,
                VEHICLE_CRASH_QUERY_RESULTS_ID INT NOT NULL,
...
CREATE TABLE SUBSCRIPTION_QUERY_RESULTS (
                SUBSCRIPTION_QUERY_RESULTS_ID INT AUTO_INCREMENT NOT NULL,
                QUERY_REQUEST_ID INT NOT NULL,
                FBI_SUBSCRIPTION_ID VARCHAR(20),
                ...
                QUERY_RESULTS_TIMEOUT_INDICATOR BOOLEAN,
				`timestamp` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
                PRIMARY KEY (SUBSCRIPTION_QUERY_RESULTS_ID)
);
...
ALTER TABLE VEHICLE_SEARCH_RESULTS ADD CONSTRAINT systems_to_search_vehicle_search_results_fk
FOREIGN KEY (SYSTEMS_TO_SEARCH_ID)
REFERENCES SYSTEMS_TO_SEARCH (SYSTEMS_TO_SEARCH_ID)
ON DELETE NO ACTION
ON UPDATE NO ACTION;

ALTER TABLE INCIDENT_SEARCH_RESULTS ADD CONSTRAINT systems_to_search_incident_search_results_fk
FOREIGN KEY (SYSTEMS_TO_SEARCH_ID)
REFERENCES SYSTEMS_TO_SEARCH (SYSTEMS_TO_SEARCH_ID)
ON DELETE NO ACTION
ON UPDATE NO ACTION;
...
ALTER TABLE INCIDENT_SEARCH_RESULTS ADD CONSTRAINT incident_search_request_incident_search_results_fk
FOREIGN KEY (INCIDENT_SEARCH_REQUEST_ID)
REFERENCES INCIDENT_SEARCH_REQUEST (INCIDENT_SEARCH_REQUEST_ID)
ON DELETE NO ACTION
ON UPDATE NO ACTION;
...
ALTER TABLE VEHICLE_SEARCH_RESULTS ADD CONSTRAINT vehicle_search_request_vehicle_search_results_fk
FOREIGN KEY (VEHICLE_SEARCH_REQUEST_ID)
REFERENCES VEHICLE_SEARCH_REQUEST (VEHICLE_SEARCH_REQUEST_ID)
ON DELETE NO ACTION
ON UPDATE NO ACTION;
...
ALTER TABLE CANNABIS_LICENSING_QUERY_RESULTS ADD CONSTRAINT query_request_cannabis_licensing_query_results_fk
FOREIGN KEY (QUERY_REQUEST_ID)
REFERENCES QUERY_REQUEST (QUERY_REQUEST_ID)
ON DELETE NO ACTION
ON UPDATE NO ACTION;
