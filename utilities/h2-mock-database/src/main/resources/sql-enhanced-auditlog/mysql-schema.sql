...
CREATE TABLE NOTIFICATIONS_SENT (
                ...
                SUBSCRIPTION_OWNER_AGENCY VARCHAR NOT NULL,
                SUBSCRIPTION_OWNER_AGENCY_TYPE VARCHAR NOT NULL,
                SUBSCRIPTION_OWNER_EMAIL_ADDRESS VARCHAR NOT NULL,
                SUBSCRIPTION_OWNER VARCHAR NOT NULL,
                SUBSCRIBING_SYSTEM_IDENTIFIER VARCHAR NOT NULL,
...
CREATE TABLE NOTIFICATION_MECHANISM (
                ...
                NOTIFICATION_MECHANSIM VARCHAR NOT NULL,
                NOTIFICATION_ADDRESS VARCHAR NOT NULL,
                NOTIFICATION_RECIPIENT_TYPE VARCHAR NOT NULL,
