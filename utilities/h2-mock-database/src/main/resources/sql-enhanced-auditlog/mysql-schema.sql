...
CREATE TABLE FEDERAL_RAPBACK_SUBSCRIPTION (
                ...
                RESPONSE_RECIEVED_TIMESTAMP timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
...
CREATE TABLE SUBSCRIPTION_VALIDATION (
                SUBSCRIPTION_VALIDATION_ID INT AUTO_INCREMENT NOT NULL,
                USER_INFO_ID INT,
                STATE_SUBSCRIPTION_ID VARCHAR(20),
                VALIDATION_DUE_DATE DATE NOT NULL,
                 `timestamp` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
                PRIMARY KEY (SUBSCRIPTION_VALIDATION_ID)
);
