...
CREATE TABLE CIVIL_INITIAL_RESULTS (CIVIL_INITIAL_RESULT_ID INT AUTO_INCREMENT NOT NULL, TRANSACTION_NUMBER VARCHAR(100) NOT NULL, MATCH_NO_MATCH BOOLEAN NOT NULL, CURRENT_STATE VARCHAR(100) NOT NULL, TRANSACTION_TYPE VARCHAR(100) NOT NULL, CIVIL_RAP_BACK_CATEGORY VARCHAR(100) NOT NULL, RESULTS_SENDER VARCHAR(30) NOT NULL, TIMESTAMP TIMESTAMP DEFAULT NOW() NOT NULL);
...
CREATE TABLE CRIMINAL_INITIAL_RESULTS (CRIMINAL_INITIAL_RESULT_ID INT AUTO_INCREMENT NOT NULL, TRANSACTION_NUMBER VARCHAR(100) NOT NULL, MATCH_NO_MATCH BOOLEAN NOT NULL, TRANSACTION_TYPE VARCHAR(100) NOT NULL, RESULTS_SENDER VARCHAR(30) NOT NULL, TIMESTAMP TIMESTAMP DEFAULT NOW() NOT NULL);
