...
CREATE TABLE SUBSEQUENT_RESULTS (SUBSEQUENT_RESULT_ID INT AUTO_INCREMENT NOT NULL, FBI_SUBSCRIPTION_ID VARCHAR(100) NOT NULL, RAP_SHEET BLOB NOT NULL, RESULTS_SENDER_ID INT NOT NULL, TIMESTAMP TIMESTAMP DEFAULT NOW() NOT NULL);
