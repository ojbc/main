...
CREATE TABLE IDENTIFICATION_TRANSACTION (TRANSACTION_NUMBER VARCHAR(100) NOT NULL, SUBJECT_ID INT NOT NULL, OTN VARCHAR(100) NOT NULL, TIMESTAMP_RECEIVED TIMESTAMP NOT NULL, OWNER_ORI VARCHAR(20) NOT NULL, OWNER_PROGRAM_OCA VARCHAR(50) NOT NULL);
...
ALTER TABLE IDENTIFICATION_TRANSACTION ADD CONSTRAINT FBI_RAP_BACK_SUBJECT_LOTC_TRANSACTION_fk FOREIGN KEY (SUBJECT_ID) REFERENCES FBI_RAP_BACK_SUBJECT (SUBJECT_ID);
