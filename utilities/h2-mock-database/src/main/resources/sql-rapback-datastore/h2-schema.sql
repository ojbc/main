...
CREATE TABLE FBI_RAP_BACK_SUBJECT (SUBJECT_ID INT AUTO_INCREMENT NOT NULL, UCN VARCHAR(100) NOT NULL, CRIMINAL_SID VARCHAR(50), CIVIL_SID VARCHAR(50), NAME VARCHAR(100) NOT NULL, DOB date NOT NULL);
