...
CREATE TABLE TRIGGERING_EVENT (
                TRIGGERING_EVENT_ID IDENTITY NOT NULL,
...
CREATE TABLE AGENCY_TRIGGERING_EVENT (
                AGENCY_TRIGGERING_EVENT_ID IDENTITY NOT NULL,
...
CREATE TABLE SUBSCRIPTION_OWNER (
                SUBSCRIPTION_OWNER_ID IDENTITY NOT NULL,
...
CREATE TABLE NSOR_FIVE_YEAR_CHECK (
                NSOR_DEMOGRAPHICS_ID IDENTITY NOT NULL,
                TRANSACTION_NUMBER VARCHAR(100) NOT NULL,
                FIVE_YEAR_CHECK_FILE BINARY,
                CREATION_TIMESTAMP TIMESTAMP DEFAULT CURRENT_TIMESTAMP() NOT NULL,
                CONSTRAINT NSOR_FIVE_YEAR_CHECK_ID PRIMARY KEY (NSOR_DEMOGRAPHICS_ID)
);

CREATE TABLE NSOR_SEARCH_RESULT (
                NSOR_SEARCH_RESULT_ID IDENTITY NOT NULL,
