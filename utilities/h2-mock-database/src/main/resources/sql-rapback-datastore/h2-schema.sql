...
CREATE TABLE FBI_RAP_BACK_SUBJECT (SUBJECT_ID INT AUTO_INCREMENT NOT NULL, UCN VARCHAR(100) NOT NULL, CRIMINAL_SID VARCHAR(50), CIVIL_SID VARCHAR(50), FIRST_NAME VARCHAR(100) NOT NULL, LAST_NAME VARCHAR(100) NOT NULL, MIDDLE_INITIAL VARCHAR(30), DOB date NOT NULL);
...
CREATE TABLE LOTC_TRANSACTION (TRANSACTION_NUMBER VARCHAR(100) NOT NULL, SUBJECT_ID INT NOT NULL, OTN VARCHAR(100) NOT NULL, TIMESTAMP_RECEIVED TIMESTAMP NOT NULL, OWNER_ORI VARCHAR(20) NOT NULL, OWNER_PROGRAM_OCA VARCHAR(50) NOT NULL);

ALTER TABLE LOTC_TRANSACTION ADD CONSTRAINT LOTC_TRANSACTION_pk PRIMARY KEY (TRANSACTION_NUMBER);

CREATE TABLE CIVIL_FINGER_PRINTS (FINGER_PRINTS_ID INT AUTO_INCREMENT NOT NULL, TRANSACTION_NUMBER VARCHAR(100) NOT NULL, FINGER_PRINTS_FILE BLOB NOT NULL, TRANSACTION_TYPE VARCHAR(100) NOT NULL, FINGER_PRINTS_TYPE VARCHAR(30) NOT NULL, TIMESTAMP TIMESTAMP NOT NULL);
...
CREATE TABLE CRIMINAL_FINGER_PRINTS (FINGER_PRINTS_ID INT AUTO_INCREMENT NOT NULL, TRANSACTION_NUMBER VARCHAR(100) NOT NULL, FINGER_PRINTS_FILE BLOB, TRANSACTION_TYPE VARCHAR(100) NOT NULL, FINGER_PRINTS_TYPE VARCHAR(30) NOT NULL, TIMESTAMP TIMESTAMP NOT NULL);
...
CREATE TABLE CRIMINAL_INITIAL_RESULTS (CRIMINAL_INITIAL_RESULT_ID INT AUTO_INCREMENT NOT NULL, SUBJECT_ID INT NOT NULL, TRANSACTION_NUMBER VARCHAR(100) NOT NULL, MATCH_NO_MATCH BOOLEAN NOT NULL, TRANSACTION_TYPE VARCHAR(100) NOT NULL, RESULTS_SENDER VARCHAR(30) NOT NULL, TIMESTAMP TIMESTAMP NOT NULL);
...
CREATE TABLE CIVIL_INITIAL_RESULTS (CIVIL_INITIAL_RESULT_ID INT AUTO_INCREMENT NOT NULL, TRANSACTION_NUMBER VARCHAR(100) NOT NULL, SUBJECT_ID INT NOT NULL, MATCH_NO_MATCH BOOLEAN NOT NULL, CURRENT_STATE VARCHAR(100) NOT NULL, TRANSACTION_TYPE VARCHAR(100) NOT NULL, CIVIL_RAP_BACK_CATEGORY VARCHAR(100) NOT NULL, RESULTS_SENDER VARCHAR(30) NOT NULL, TIMESTAMP TIMESTAMP NOT NULL);
...
CREATE TABLE CIVIL_INITIAL_RAP_SHEET (CIVIL_RAPSHEET_ID INT AUTO_INCREMENT NOT NULL, CIVIL_INITIAL_RESULT_ID INT NOT NULL, RAP_SHEET BLOB NOT NULL, TRANSACTION_TYPE VARCHAR(100) NOT NULL, TIMESTAMP TIMESTAMP NOT NULL);
...
CREATE TABLE CIVIL_FBI_SUBSCRIPTION_RECORD (CIVIL_FBI_SUBSCRIPTION_ID INT AUTO_INCREMENT NOT NULL, SUBSCRIPTION_ID INT NOT NULL, FBI_SUBSCRIPTION_ID VARCHAR(100) NOT NULL, CIVIL_INITIAL_RESULT_ID INT NOT NULL, LAST_MODIFIED_BY VARCHAR(100) NOT NULL);

CREATE SEQUENCE CIVIL_FBI_SUBSCRIPTION_RECORD_CIVIL_FBI_SUBSCRIPTION_ID_seq;

CREATE TABLE CRIMINAL_FBI_SUBSCRIPTION_RECORD (CRIMINAL_FBI_SUBSCRIPTION_ID INT AUTO_INCREMENT NOT NULL, FBI_SUBSCRIPTION_ID VARCHAR(100) NOT NULL, SUBSCRIPTION_ID INT NOT NULL, FBI_OCA VARCHAR(100) NOT NULL);
...
ALTER TABLE LOTC_TRANSACTION ADD CONSTRAINT FBI_RAP_BACK_SUBJECT_LOTC_TRANSACTION_fk FOREIGN KEY (SUBJECT_ID) REFERENCES FBI_RAP_BACK_SUBJECT (SUBJECT_ID);
