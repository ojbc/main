...
CREATE SEQUENCE CURRENT_STATE_CURRENT_STATE_ID_seq_1;
...
CREATE TABLE IDENTIFICATION_TRANSACTION (TRANSACTION_NUMBER VARCHAR(100) NOT NULL, OTN VARCHAR(100) NOT NULL, OWNER_ORI VARCHAR(20) NOT NULL, OWNER_PROGRAM_OCA VARCHAR(50) NOT NULL, SUBJECT_ID INT NOT NULL, IDENTIFICATION_CATEGORY VARCHAR(20) NOT NULL, TIMESTAMP TIMESTAMP DEFAULT NOW() NOT NULL, CURRENT_STATE_ID INT NOT NULL);
...
ALTER TABLE IDENTIFICATION_TRANSACTION ADD CONSTRAINT CURRENT_STATE_IDENTIFICATION_TRANSACTION_fk FOREIGN KEY (CURRENT_STATE_ID) REFERENCES CURRENT_STATE (CURRENT_STATE_ID);
