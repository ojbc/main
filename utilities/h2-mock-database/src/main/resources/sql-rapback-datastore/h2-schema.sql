...
CREATE TABLE CIVIL_FINGER_PRINTS (FINGER_PRINTS_ID INT AUTO_INCREMENT NOT NULL, TRANSACTION_NUMBER VARCHAR(0) NOT NULL, FINGER_PRINTS_FILE BLOB NOT NULL, TRANSACTION_TYPE VARCHAR(0) NOT NULL, FINGER_PRINTS_TYPE VARCHAR(0) NOT NULL, TIMESTAMP TIMESTAMP NOT NULL);
...
CREATE TABLE CRIMINAL_FINGER_PRINTS (FINGER_PRINTS_ID INT AUTO_INCREMENT NOT NULL, TRANSACTION_NUMBER VARCHAR(0) NOT NULL, FINGER_PRINTS_FILE BLOB, TRANSACTION_TYPE VARCHAR(0) NOT NULL, FINGER_PRINTS_TYPE VARCHAR(0) NOT NULL, TIMESTAMP TIMESTAMP NOT NULL);
...
CREATE TABLE FBI_RAP_BACK_SUBJECT (SUBJECT_ID INT AUTO_INCREMENT NOT NULL, UCN VARCHAR(0) NOT NULL, CRIMINAL_SID VARCHAR(0), CIVIL_SID VARCHAR(0), NAME VARCHAR(0) NOT NULL, DOB date NOT NULL);
...
CREATE TABLE CRIMINAL_INITIAL_RESULTS (CRIMINAL_INITIAL_RESULT_ID INT AUTO_INCREMENT NOT NULL, SUBJECT_ID INT NOT NULL, TRANSACTION_NUMBER VARCHAR(0) NOT NULL, MATCH_NO_MATCH BOOLEAN NOT NULL, TRANSACTION_TYPE VARCHAR(0) NOT NULL, RESULTS_SENDER VARCHAR(0) NOT NULL, TIMESTAMP TIMESTAMP NOT NULL);
...
CREATE TABLE CIVIL_INITIAL_RESULTS (CIVIL_INITIAL_RESULT_ID INT AUTO_INCREMENT NOT NULL, TRANSACTION_NUMBER VARCHAR(0) NOT NULL, SUBJECT_ID INT NOT NULL, MATCH_NO_MATCH BOOLEAN NOT NULL, CURRENT_STATE VARCHAR(0) NOT NULL, TRANSACTION_TYPE VARCHAR(0) NOT NULL, CIVIL_RAP_BACK_CATEGORY VARCHAR(0) NOT NULL, RESULTS_SENDER VARCHAR(0) NOT NULL, TIMESTAMP TIMESTAMP NOT NULL);
...
CREATE TABLE CIVIL_INITIAL_RAP_SHEET (CIVIL_RAPSHEET_ID INT AUTO_INCREMENT NOT NULL, CIVIL_INITIAL_RESULT_ID INT NOT NULL, RAP_SHEET BLOB NOT NULL, TRANSACTION_TYPE VARCHAR(0) NOT NULL, TIMESTAMP TIMESTAMP NOT NULL);

CREATE SEQUENCE CIVIL_INITIAL_RAP_SHEET_CIVIL_RAPSHEET_ID_seq;

CREATE TABLE FBI_RAP_BACK_SUBSCRIPTION (FBI_SUBSCRIPTION_ID VARCHAR(0) NOT NULL, SUBJECT_ID INT NOT NULL, RAP_BACK_CATEGORY VARCHAR(0) NOT NULL, SUBSCRIPTION_TERM VARCHAR(0) NOT NULL, RAP_BACK_SUBSCRIPTION_IDENTIFIER VARCHAR(0) NOT NULL, RAP_BACK_EXPIRATION_DATE date NOT NULL, RAP_BACK_START_DATE date NOT NULL, RAP_BACK_OPT_OUT_IN_STATE_INDICATOR BOOLEAN NOT NULL, RAP_BACK_ACTIVITY_NOTIFICATION_FORMAT VARCHAR(0) NOT NULL);

ALTER TABLE FBI_RAP_BACK_SUBSCRIPTION ADD CONSTRAINT FBI_RAP_BACK_SUBSCRIPTION_pk PRIMARY KEY (FBI_SUBSCRIPTION_ID);

CREATE TABLE SUBSEQUENT_RESULTS (SUBSEQUENT_RESULT_ID INT AUTO_INCREMENT NOT NULL, TRANSACTION_NUMBER VARCHAR(0) NOT NULL, FBI_SUBSCRIPTION_ID VARCHAR(0) NOT NULL, SUBJECT_ID INT NOT NULL, RAP_BACK_SUBSCRIPTION_IDENTIFIER VARCHAR(0) NOT NULL, MATCH_NO_MATCH BOOLEAN NOT NULL, RAP_SHEET BLOB NOT NULL, TRANSACTION_TYPE VARCHAR(0) NOT NULL, TIMESTAMP TIMESTAMP NOT NULL);
...
CREATE TABLE CIVIL_FBI_SUBSCRIPTION_RECORD (CIVIL_FBI_SUBSCRIPTION_ID INT AUTO_INCREMENT NOT NULL, SUBSCRIPTION_ID INT NOT NULL, FBI_SUBSCRIPTION_ID VARCHAR(0) NOT NULL, CIVIL_INITIAL_RESULT_ID INT NOT NULL, LAST_MODIFIED_BY VARCHAR(0) NOT NULL);

CREATE SEQUENCE CIVIL_FBI_SUBSCRIPTION_RECORD_CIVIL_FBI_SUBSCRIPTION_ID_seq;

CREATE TABLE CRIMINAL_FBI_SUBSCRIPTION_RECORD (CRIMINAL_FBI_SUBSCRIPTION_ID INT AUTO_INCREMENT NOT NULL, FBI_SUBSCRIPTION_ID VARCHAR(0) NOT NULL, SUBSCRIPTION_ID INT NOT NULL, FBI_OCA VARCHAR(0) NOT NULL);
...
ALTER TABLE CRIMINAL_FINGER_PRINTS ADD CONSTRAINT LOTC_TRANSACTION_CRIMINAL_NISTS_fk FOREIGN KEY (TRANSACTION_NUMBER) REFERENCES LOTC_TRANSACTION (TRANSACTION_NUMBER) ON DELETE CASCADE;
...
ALTER TABLE CIVIL_FINGER_PRINTS ADD CONSTRAINT LOTC_TRANSACTION_CIVIL_NISTS_fk FOREIGN KEY (TRANSACTION_NUMBER) REFERENCES LOTC_TRANSACTION (TRANSACTION_NUMBER);
...
ALTER TABLE CRIMINAL_INITIAL_RESULTS ADD CONSTRAINT FBI_RAP_BACK_SUBJECT_CRIMINAL_INITIAL_RESULTS_fk FOREIGN KEY (SUBJECT_ID) REFERENCES FBI_RAP_BACK_SUBJECT (SUBJECT_ID);

ALTER TABLE SUBSEQUENT_RESULTS ADD CONSTRAINT FBI_RAP_BACK_SUBJECT_SUBSEQUENT_RESULTS_fk FOREIGN KEY (SUBJECT_ID) REFERENCES FBI_RAP_BACK_SUBJECT (SUBJECT_ID);
