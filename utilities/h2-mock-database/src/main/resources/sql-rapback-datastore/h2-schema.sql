...
CREATE TABLE IDENTIFICATION_TRANSACTION (TRANSACTION_NUMBER VARCHAR(100) NOT NULL, SUBJECT_ID INT NOT NULL, OTN VARCHAR(100) NOT NULL, OWNER_ORI VARCHAR(20) NOT NULL, OWNER_PROGRAM_OCA VARCHAR(50) NOT NULL, IDENTIFICATION_CATEGORY VARCHAR(20) NOT NULL, ARCHIVED BOOLEAN DEFAULT FALSE NOT NULL, SUBSCRIPTION_ID INT, AVAILABLE_FOR_SUBSCRIPITON_START_DATE TIMESTAMP DEFAULT NOW() NOT NULL, TIMESTAMP TIMESTAMP DEFAULT NOW() NOT NULL);

ALTER TABLE IDENTIFICATION_TRANSACTION ADD CONSTRAINT identification_transaction_pk PRIMARY KEY (TRANSACTION_NUMBER);

CREATE TABLE CIVIL_FINGER_PRINTS (FINGER_PRINTS_ID INT AUTO_INCREMENT NOT NULL, TRANSACTION_NUMBER VARCHAR(100) NOT NULL, FINGER_PRINTS_FILE BLOB NOT NULL, FINGER_PRINTS_TYPE_ID INT NOT NULL, TIMESTAMP TIMESTAMP DEFAULT NOW() NOT NULL);
...
CREATE TABLE CIVIL_INITIAL_RESULTS (CIVIL_INITIAL_RESULT_ID INT AUTO_INCREMENT NOT NULL, SEARCH_RESULT_FILE BLOB, TRANSACTION_NUMBER VARCHAR(100) NOT NULL, RESULTS_SENDER_ID INT NOT NULL, TIMESTAMP TIMESTAMP DEFAULT NOW() NOT NULL);
...
CREATE TABLE CRIMINAL_INITIAL_RESULTS (CRIMINAL_INITIAL_RESULT_ID INT AUTO_INCREMENT NOT NULL, TRANSACTION_NUMBER VARCHAR(100) NOT NULL, SEARCH_RESULT_FILE BLOB, RESULTS_SENDER_ID INT NOT NULL, TIMESTAMP TIMESTAMP DEFAULT NOW() NOT NULL);
