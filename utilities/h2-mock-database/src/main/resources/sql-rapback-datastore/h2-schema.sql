...
CREATE TABLE FBI_RAP_BACK_SUBSCRIPTION (FBI_SUBSCRIPTION_ID VARCHAR(100) NOT NULL, RAP_BACK_EXPIRATION_DATE date NOT NULL, RAP_BACK_START_DATE date NOT NULL, RAP_BACK_OPT_OUT_IN_STATE_INDICATOR BOOLEAN NOT NULL, UCN VARCHAR(100) NOT NULL, TIMESTAMP TIMESTAMP DEFAULT NOW() NOT NULL, RAP_BACK_CATEGORY_CODE VARCHAR(2) NOT NULL, RAP_BACK_ACTIVITY_NOTIFICATION_FORMAT_CODE VARCHAR(1) NOT NULL, RAP_BACK_SUBSCRIPTION_TERM_CODE VARCHAR(1) NOT NULL);
