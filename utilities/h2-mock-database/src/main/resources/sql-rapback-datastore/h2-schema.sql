...
CREATE TABLE FBI_RAP_BACK_SUBSCRIPTION (FBI_SUBSCRIPTION_ID VARCHAR(100) NOT NULL, RAP_BACK_CATEGORY VARCHAR(100) NOT NULL, SUBSCRIPTION_TERM VARCHAR(50) NOT NULL, FBI_OCA VARCHAR(100) NOT NULL, RAP_BACK_EXPIRATION_DATE date NOT NULL, RAP_BACK_START_DATE date NOT NULL, RAP_BACK_OPT_OUT_IN_STATE_INDICATOR BOOLEAN NOT NULL, RAP_BACK_ACTIVITY_NOTIFICATION_FORMAT VARCHAR(100) NOT NULL, UCN VARCHAR(100) NOT NULL, TIMESTAMP TIMESTAMP DEFAULT NOW() NOT NULL);

ALTER TABLE FBI_RAP_BACK_SUBSCRIPTION ADD CONSTRAINT FBI_RAP_BACK_SUBSCRIPTION_pk PRIMARY KEY (FBI_SUBSCRIPTION_ID);

CREATE TABLE SUBSCRIPTION (ID INT AUTO_INCREMENT NOT NULL, TOPIC VARCHAR(100) NOT NULL, STARTDATE date NOT NULL, ENDDATE date DEFAULT null, LASTVALIDATIONDATE date DEFAULT null, SUBSCRIBINGSYSTEMIDENTIFIER VARCHAR(100) NOT NULL, SUBSCRIPTIONOWNER VARCHAR(100) NOT NULL, SUBJECTNAME VARCHAR(100) NOT NULL, ACTIVE TINYINT NOT NULL, AGENCY_CASE_NUMBER VARCHAR(100), TIMESTAMP TIMESTAMP DEFAULT NOW());
