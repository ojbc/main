...
CREATE TABLE IDENTIFICATION_TRANSACTION (TRANSACTION_NUMBER VARCHAR(100) NOT NULL, OTN VARCHAR(100) NOT NULL, OWNER_ORI VARCHAR(20) NOT NULL, OWNER_PROGRAM_OCA VARCHAR(50) NOT NULL, SUBJECT_ID INT NOT NULL, IDENTIFICATION_CATEGORY VARCHAR(20) NOT NULL, TIMESTAMP TIMESTAMP DEFAULT NOW() NOT NULL, ARCHIVED BOOLEAN DEFAULT FALSE NOT NULL);
