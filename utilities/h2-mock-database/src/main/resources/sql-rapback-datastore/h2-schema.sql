...
CREATE TABLE LOTC_TRANSACTION (TRANSACTION_NUMBER VARCHAR(100) NOT NULL, OTN VARCHAR(100) NOT NULL, TIMESTAMP_RECEIVED TIMESTAMP NOT NULL, OWNER_ORI VARCHAR(20) NOT NULL, OWNER_PROGRAM_OCA VARCHAR(50) NOT NULL);
