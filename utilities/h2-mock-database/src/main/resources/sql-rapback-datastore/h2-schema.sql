...
CREATE TABLE CURRENT_STATE (CURRENT_STATE_ID INT AUTO_INCREMENT NOT NULL, CURRENT_STATE VARCHAR(50) NOT NULL);

ALTER TABLE CURRENT_STATE ADD CONSTRAINT STATE PRIMARY KEY (CURRENT_STATE_ID);

CREATE SEQUENCE CURRENT_STATE_CURRENT_STATE_ID_seq;
...
CREATE TABLE IDENTIFICATION_TRANSACTION (TRANSACTION_NUMBER VARCHAR(100) NOT NULL, OTN VARCHAR(100) NOT NULL, OWNER_ORI VARCHAR(20) NOT NULL, OWNER_PROGRAM_OCA VARCHAR(50) NOT NULL, SUBJECT_ID INT NOT NULL, IDENTIFICATION_CATEGORY VARCHAR(20) NOT NULL, TIMESTAMP TIMESTAMP DEFAULT NOW() NOT NULL);
...
CREATE TABLE CIVIL_INITIAL_RESULTS (CIVIL_INITIAL_RESULT_ID INT AUTO_INCREMENT NOT NULL, TRANSACTION_NUMBER VARCHAR(100) NOT NULL, SEARCH_RESULT_FILE BLOB, TRANSACTION_TYPE VARCHAR(100) NOT NULL, TIMESTAMP TIMESTAMP DEFAULT NOW() NOT NULL, RESULTS_SENDER_ID INT NOT NULL, CURRENT_STATE_ID INT NOT NULL);
...
CREATE TABLE CIVIL_FBI_SUBSCRIPTION_RECORD (CIVIL_FBI_SUBSCRIPTION_ID INT AUTO_INCREMENT NOT NULL, SUBSCRIPTION_ID INT NOT NULL, FBI_SUBSCRIPTION_ID VARCHAR(100) NOT NULL, TRANSACTION_NUMBER VARCHAR(100) NOT NULL, LAST_MODIFIED_BY VARCHAR(100) NOT NULL, TIMESTAMP VARCHAR(0) DEFAULT 'CURRENT_TIMESTAMP()' NOT NULL);
...
ALTER TABLE CIVIL_INITIAL_RESULTS ADD CONSTRAINT CIVIL_INITIAL_RESULTS_STATE_CIVIL_INITIAL_RESULTS_fk FOREIGN KEY (CURRENT_STATE_ID) REFERENCES CURRENT_STATE (CURRENT_STATE_ID);
...
ALTER TABLE CIVIL_FBI_SUBSCRIPTION_RECORD ADD CONSTRAINT CIVIL_FBI_SUBSCRIPTION_RECORD_IDENTIFICATION_TRANSACTION_fk FOREIGN KEY (TRANSACTION_NUMBER) REFERENCES IDENTIFICATION_TRANSACTION (TRANSACTION_NUMBER);
