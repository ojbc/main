...
CREATE TABLE FBI_RAP_BACK_SUBSCRIPTION (FBI_SUBSCRIPTION_ID VARCHAR(100) NOT NULL, RAP_BACK_CATEGORY VARCHAR(100) NOT NULL, SUBSCRIPTION_TERM VARCHAR(50) NOT NULL, FBI_OCA VARCHAR(100) NOT NULL, RAP_BACK_SUBSCRIPTION_IDENTIFIER VARCHAR(100) NOT NULL, RAP_BACK_EXPIRATION_DATE date NOT NULL, RAP_BACK_START_DATE date NOT NULL, RAP_BACK_OPT_OUT_IN_STATE_INDICATOR BOOLEAN NOT NULL, RAP_BACK_ACTIVITY_NOTIFICATION_FORMAT VARCHAR(100) NOT NULL, TIMESTAMP TIMESTAMP DEFAULT NOW() NOT NULL);

ALTER TABLE FBI_RAP_BACK_SUBSCRIPTION ADD CONSTRAINT FBI_RAP_BACK_SUBSCRIPTION_pk PRIMARY KEY (FBI_SUBSCRIPTION_ID);

CREATE TABLE IDENTIFICATION_SUBJECT (SUBJECT_ID INT AUTO_INCREMENT NOT NULL, UCN VARCHAR(100), CRIMINAL_SID VARCHAR(50), CIVIL_SID VARCHAR(50), FIRST_NAME VARCHAR(100) NOT NULL, LAST_NAME VARCHAR(100) NOT NULL, MIDDLE_INITIAL VARCHAR(30), SEX_CODE VARCHAR(1), DOB date, FBI_SUBSCRIPTION_ID VARCHAR(100));
...
ALTER TABLE IDENTIFICATION_SUBJECT ADD CONSTRAINT FBI_RAP_BACK_SUBSCRIPTION_IDENTIFICATION_SUBJECT_fk FOREIGN KEY (FBI_SUBSCRIPTION_ID) REFERENCES FBI_RAP_BACK_SUBSCRIPTION (FBI_SUBSCRIPTION_ID);
