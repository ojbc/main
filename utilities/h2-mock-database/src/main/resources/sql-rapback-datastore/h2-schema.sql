...
CREATE TABLE FBI_RAP_BACK_SUBJECT (SUBJECT_ID INT AUTO_INCREMENT NOT NULL, UCN VARCHAR(100) NOT NULL, CRIMINAL_SID VARCHAR(50), CIVIL_SID VARCHAR(50), FIRST_NAME VARCHAR(100) NOT NULL, LAST_NAME VARCHAR(100) NOT NULL, MIDDLE_INITIAL VARCHAR(30), SEX_CODE VARCHAR(1), DOB date);
