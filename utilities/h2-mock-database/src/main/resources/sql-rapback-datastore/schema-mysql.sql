 ...
 * For timestamps, use an example like this:  REPORT_TIMESTAMP TIMESTAMP DEFAULT CURRENT_TIMESTAMP NOT NULL ON UPDATE CURRENT_TIMESTAMP,
 * 
 */
...
CREATE TABLE SUBSEQUENT_RESULTS (
                ...
                REPORT_TIMESTAMP TIMESTAMP DEFAULT CURRENT_TIMESTAMP NOT NULL ON UPDATE CURRENT_TIMESTAMP,
...
CREATE TABLE IDENTIFICATION_TRANSACTION (
                ...
                SUBSCRIPTION_ID INT,
                AVAILABLE_FOR_SUBSCRIPTION_START_DATE DATETIME DEFAULT current_timestamp() NOT NULL,
                REPORT_TIMESTAMP TIMESTAMP DEFAULT CURRENT_TIMESTAMP NOT NULL ON UPDATE CURRENT_TIMESTAMP,
