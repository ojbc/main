...
insert into CIVIL_FINGER_PRINTS (TRANSACTION_NUMBER, FINGER_PRINTS_FILE, TRANSACTION_TYPE, FINGER_PRINTS_TYPE) 
	values ('000001820140729014008339990', RAWTOHEX('FBICivilFingerPrints'), 'Transaction', 'FBI');
insert into CIVIL_FINGER_PRINTS (TRANSACTION_NUMBER, FINGER_PRINTS_FILE, TRANSACTION_TYPE, FINGER_PRINTS_TYPE) 
	values ('000001820140729014008339990', RAWTOHEX('StateCivilFingerPrints'), 'Transaction', 'STATE');

insert into CRIMINAL_FINGER_PRINTS (TRANSACTION_NUMBER, FINGER_PRINTS_FILE, TRANSACTION_TYPE, FINGER_PRINTS_TYPE) 
	values ('000001820140729014008339991', RAWTOHEX('FBICriminalFingerPrints'), 'Transaction', 'FBI');
insert into CRIMINAL_FINGER_PRINTS (TRANSACTION_NUMBER, FINGER_PRINTS_FILE, TRANSACTION_TYPE, FINGER_PRINTS_TYPE) 
	values ('000001820140729014008339991', RAWTOHEX('StateCriminalFingerPrints'), 'Transaction', 'STATE');
