...
insert into CIVIL_INITIAL_RESULTS (CIVIL_INITIAL_RESULT_ID,TRANSACTION_NUMBER, SEARCH_RESULT_FILE, CURRENT_STATE_ID, 
	TRANSACTION_TYPE, RESULTS_SENDER_ID)
	values ('1', '000001820140729014008339990', RAWTOHEX('Match'), '2', 'Transaction', '1');
insert into CIVIL_INITIAL_RESULTS (CIVIL_INITIAL_RESULT_ID,TRANSACTION_NUMBER, SEARCH_RESULT_FILE, CURRENT_STATE_ID, 
	TRANSACTION_TYPE,  RESULTS_SENDER_ID) 
	values ('2', '000001820140729014008339990', RAWTOHEX('Match'), '2', 'Transaction', '2');
