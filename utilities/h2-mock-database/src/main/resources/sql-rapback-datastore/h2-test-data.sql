...
insert into CIVIL_INITIAL_RESULTS (CIVIL_INITIAL_RESULT_ID,TRANSACTION_NUMBER, SEARCH_RESULT_FILE, 
	...
	values ('1', '000001820140729014008339990', RAWTOHEX('Found a Match'), 'Transaction', '1');
insert into CIVIL_INITIAL_RESULTS (CIVIL_INITIAL_RESULT_ID,TRANSACTION_NUMBER, SEARCH_RESULT_FILE, 
	TRANSACTION_TYPE,  RESULTS_SENDER_ID) 
	values ('2', '000001820140729014008339990', RAWTOHEX('Found a Match'), 'Transaction', '2');
insert into CIVIL_INITIAL_RESULTS (CIVIL_INITIAL_RESULT_ID,TRANSACTION_NUMBER, SEARCH_RESULT_FILE, 
	TRANSACTION_TYPE, RESULTS_SENDER_ID)
	values ('3', '000001820140729014008339993', RAWTOHEX('Found a Match'), 'Transaction', '1');
insert into CIVIL_INITIAL_RESULTS (CIVIL_INITIAL_RESULT_ID,TRANSACTION_NUMBER, SEARCH_RESULT_FILE, 
	TRANSACTION_TYPE,  RESULTS_SENDER_ID) 
	values ('4', '000001820140729014008339993', RAWTOHEX('Found a Match'), 'Transaction', '2');
...
insert into CIVIL_INITIAL_RAP_SHEET (CIVIL_INITIAL_RESULT_ID, RAP_SHEET, TRANSACTION_TYPE) values ('1', RAWTOHEX('FBICivilRapSheet2'), 'Transaction');	
...
insert into CIVIL_INITIAL_RAP_SHEET (CIVIL_INITIAL_RESULT_ID, RAP_SHEET, TRANSACTION_TYPE) values ('2', RAWTOHEX('StateCivilRapSheet2'), 'Transaction');	
