...
insert into AGENCY_PROFILE(AGENCY_ID, AGENCY_ORI, AGENCY_NAME, FBI_SUBSCRIPTION_QUALIFICATION, STATE_SUBSCRIPTION_QUALIFICATION,FIREARMS_SUBSCRIPTION_QUALIFICATION,CJ_EMPLOYMENT_SUBSCRIPTION_QUALIFICATION ) values ('1', '1234567890', 'Demo Agency', 'true', true, true, true); 
insert into AGENCY_PROFILE(AGENCY_ID, AGENCY_ORI, AGENCY_NAME, FBI_SUBSCRIPTION_QUALIFICATION, STATE_SUBSCRIPTION_QUALIFICATION,FIREARMS_SUBSCRIPTION_QUALIFICATION,CJ_EMPLOYMENT_SUBSCRIPTION_QUALIFICATION ) values ('2', '68796860', 'Test Agency', 'true', true, true, true); 
