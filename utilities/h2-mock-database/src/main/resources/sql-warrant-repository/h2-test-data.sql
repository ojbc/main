...
INSERT INTO PUBLIC.WARRANTREMARKS(WARRANTREMARKSID, WARRANTID, WARRANTREMARKTEXT) VALUES
(1, 1, 'CASH ONLY BOND');

INSERT INTO PUBLIC.PERSON(PERSONID, FIRSTNAME, MIDDLENAME, LASTNAME, NAMESUFFIX, FULLPERSONNAME, ADDRESSFULLTEXT, ADDRESSCITY, ADDRESSSTATE, ADDRESSZIP, SOCIALSECURITYNUMBERBASE, DATEOFBIRTH, PLACEOFBIRTH, PERSONAGE, OPERATORLICENSENUMBERBASE, OPERATORLICENSESTATEBASE, PERSONETHNICITYDESCRIPTION, PERSONEYECOLORDESCRIPTION, PERSONHAIRCOLORDESCRIPTION, PERSONSEXDESCRIPTION, PERSONRACEDESCRIPTION, PERSONSKINTONEDESCRIPTION, PERSONHEIGHT, PERSONWEIGHT, PERSONSCARSMARKSTATTOSBASE, PERSONCITIZENSHIPCOUNTRY, USCITIZENSHIPINDICATOR, PERSONIMMIGRATIONALIENQUERYIND, PERSONSTATEIDENTIFICATION, FBIIDENTIFICATIONNUMBER, MISCELLANEOUSIDBASE, PRISONRECORDNUMBER, PERSONCAUTIONDESCRIPTION) VALUES
(1, 'Peter', 'J', 'Jones', 'Jr', 'Peter J Jones Jr', '123 TEST DRIVE', 'Detroit', 'MI', '96733', '098213455', DATE '1967-08-13', 'CA', '49', 'DL0983456', 'MI', 'N', 'BLK', 'ONG', 'M', 'W', 'ALB', '71', '165', '259', 'AO', TRUE, FALSE, 'SID56567', '354786908', 'PS-123456', 'PN3929593', 'G4');

INSERT INTO PUBLIC.VEHICLE(VEHICLEID, PERSONID, LICENSEPLATETYPE, VEHICLELICENSEPLATEEXPIRATIOND, VEHICLENONEXPIRINGINDICATOR, VEHICLELICENSEPLATENUMBER, VEHICLELICENSESTATECODE, VEHICLEIDENTIFICATIONNUMBER, VEHICLEYEAR, VEHICLEMODEL, VEHICLEMAKE, VEHICLEPRIMARYCOLOR, VEHICLESECONDARYCOLOR, VEHICLESTYLE) VALUES
...
INSERT INTO PUBLIC.PERSONALTERNATENAME(PERSONALTERNATENAMEID, PERSONID, FIRSTNAME, FULLPERSONNAME, LASTNAME, MIDDLENAME, NAMESUFFIX) VALUES
(1, 1, 'Pete', 'Pete K Johnson Jr', 'Johnson', 'K', 'Jr');

INSERT INTO PUBLIC.CHARGEREF(CHARGEREFID, PERSONID, REPORTINGAGENCYORI, CASEAGENCYCOMPLAINTNUMBER, TRANSACTIONCONTROLNUMBER, REPORTINGAGENCYNAME) VALUES
