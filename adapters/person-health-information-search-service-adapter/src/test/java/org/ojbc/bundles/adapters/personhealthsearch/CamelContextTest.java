 ...
 */
package org.ojbc.bundles.adapters.personhealthsearch;
...
public class CamelContextTest {
    ...
    public void testPersonHealthSearchRequest() throws Exception {
		...
		Exchange returnExchange = template.send("direct:personHealthRequestRouteMockEntry", senderExchange);
		...
		Exchange ex = personHealthResponseEndpoint.getExchanges().get(0);
		...
		assertNotNull(actualResponseDocument);
		assertNotNull(XmlUtils.xPathNodeSearch(actualResponseDocument, "/phisres-doc:PersonHealthInformationSearchResults"));
