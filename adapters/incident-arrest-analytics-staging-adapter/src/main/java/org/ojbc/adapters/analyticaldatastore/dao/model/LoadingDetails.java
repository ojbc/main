...
public class LoadingDetails {
	...
	//pk
	private Integer loadingDetailsID;
	
    private Time loadStartTime;
	
	private Time loadEndTime;
	
    public Integer getLoadingDetailsID() {
        return loadingDetailsID;
    }

    public void setLoadingDetailsID(Integer loadingDetailsID) {
        this.loadingDetailsID = loadingDetailsID;
    }

    public Time getLoadStartTime() {
