...
DROP TABLE IF EXISTS AssessedNeed;

CREATE TABLE AssessedNeed (
    AssessedNeedID BIGINT GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
    AssessedNeedDescription VARCHAR(30) NOT NULL UNIQUE
);

ALTER TABLE AssessedNeed ADD CONSTRAINT uq_assessedneed_desc UNIQUE (AssessedNeedDescription);
