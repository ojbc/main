...
<xsl:stylesheet version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
	...
	xmlns:j41="http://niem.gov/niem/domains/jxdm/4.1" exclude-result-prefixes="ebts ansi-nist itl nc20 j41">
	...
	<xsl:template match="ebts:UserDefinedElementText" mode="fingerprintTransaction">
		<chc-report-ext:FingerprintIdentificationTransactionIdentification>
			<nc:IdentificationID>
