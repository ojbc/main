...
<xsl:stylesheet version="2.0"
	...
	xmlns:fed_subcr_upd-ext="http://ojbc.org/IEPD/Extensions/FederalSubscriptionUpdateReportExtension/1.0"
	...
	<!-- xsl:template match="ebts:RecordRapBackCategoryCode"> <fed_subcr_upd-ext:RapBackCategoryCode> 
		<xsl:value-of select="."/> </fed_subcr_upd-ext:RapBackCategoryCode> </xsl:template -->
