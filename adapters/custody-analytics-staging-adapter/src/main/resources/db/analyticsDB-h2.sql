...
CREATE TABLE BookingCharge (BookingChargeID INT AUTO_INCREMENT NOT NULL, BookingID BIGINT NOT NULL, ChargeTypeID INT NOT NULL, BondAmount DECIMAL(12, 2) DEFAULT 0 NOT NULL, BondTypeID INT NOT NULL);
