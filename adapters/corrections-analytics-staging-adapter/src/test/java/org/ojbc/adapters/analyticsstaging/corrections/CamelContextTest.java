 ...
 */
package org.ojbc.adapters.analyticsstaging.corrections;
...
public class CamelContextTest {
	...
	public void setUp() throws Exception {
    	...
    	context.getRouteDefinition("arrest_reporting_service").adviceWith(context, new AdviceWithRouteBuilder() {
    	    @Override
    	...
    	context.getRouteDefinition("process_arrest_report").adviceWith(context, new AdviceWithRouteBuilder() {
    	    @Override
    	    public void configure() throws Exception {
	...
	@Test
	public void testCriminalIdentificationReportServiceRoute() throws Exception, IOException {
