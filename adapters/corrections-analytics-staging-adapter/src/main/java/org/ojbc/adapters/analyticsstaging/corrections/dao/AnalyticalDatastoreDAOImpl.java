 ...
 */
package org.ojbc.adapters.analyticsstaging.corrections.dao;
...
import org.ojbc.adapters.analyticsstaging.corrections.dao.model.Address;
import org.ojbc.adapters.analyticsstaging.corrections.dao.model.BehavioralHealthAssessment;
import org.ojbc.adapters.analyticsstaging.corrections.dao.model.Booking;
import org.ojbc.adapters.analyticsstaging.corrections.dao.model.BookingArrest;
import org.ojbc.adapters.analyticsstaging.corrections.dao.model.BookingCharge;
import org.ojbc.adapters.analyticsstaging.corrections.dao.model.CustodyRelease;
import org.ojbc.adapters.analyticsstaging.corrections.dao.model.CustodyStatusChange;
import org.ojbc.adapters.analyticsstaging.corrections.dao.model.CustodyStatusChangeArrest;
import org.ojbc.adapters.analyticsstaging.corrections.dao.model.CustodyStatusChangeCharge;
import org.ojbc.adapters.analyticsstaging.corrections.dao.model.KeyValue;
import org.ojbc.adapters.analyticsstaging.corrections.dao.model.Person;
import org.ojbc.adapters.analyticsstaging.corrections.dao.model.PersonRace;
import org.ojbc.adapters.analyticsstaging.corrections.dao.model.PersonSex;
import org.ojbc.adapters.analyticsstaging.corrections.dao.model.PrescribedMedication;
import org.ojbc.adapters.analyticsstaging.corrections.dao.model.Treatment;
...
public class AnalyticalDatastoreDAOImpl implements AnalyticalDatastoreDAO{
        	        ...
        	        public PreparedStatement createPreparedStatement(Connection connection) throws SQLException {
        	        	...
        	        	if (booking.getBookingId() != null){
        	        		...
        	        		sqlString="INSERT into booking ("
        	        				...
        	        				+ "PersonID, BookingNumber, ScheduledReleaseDate, InmateJailResidentIndicator, InmateCurrentLocation, BookingID) "
        	        				+ "values (?,?,?,?,?,?,?,?,?,?)";
        	        	}	
        	        	else{
        	        		...
        	        		sqlString="INSERT into booking ("
        	        				...
        	        				+ "PersonID, BookingNumber, ScheduledReleaseDate, InmateJailResidentIndicator, InmateCurrentLocation) "
        	        				+ "values (?,?,?,?,?,?,?,?,?)";
        	            ...
        	            setPreparedStatementVariable(booking.getInmateCurrentLocation(), ps, 9);
                        
        	            if (booking.getBookingId() != null){
        	            	setPreparedStatementVariable(booking.getBookingId(), ps, 10);
        	            }
	...
	public class BookingRowMapper implements RowMapper<Booking>
	{
		...
		public Booking mapRow(ResultSet rs, int rowNum) throws SQLException {
			...
			booking.setInmateCurrentLocation( rs.getString("InmateCurrentLocation"));
        	        ...
        	        public PreparedStatement createPreparedStatement(Connection connection) throws SQLException {
        	        	...
        	        	if (custodyStatusChange.getCustodyStatusChangeId() != null){
        	        		...
        	        		sqlString="INSERT into custodyStatusChange ("
        	        				+ "BookingDate, BookingTime,  "
        	        				+ "FacilityID, SupervisionUnitTypeID, "
        	        				+ "PersonID, BookingId, ScheduledReleaseDate, InmateJailResidentIndicator, BookingNumber, InmateCurrentLocation, "
        	            ...
        	            setPreparedStatementVariable(custodyStatusChange.getInmateCurrentLocation(), ps, 10);
        	            
        	            if (custodyStatusChange.getCustodyStatusChangeId() != null){
        	            	setPreparedStatementVariable(custodyStatusChange.getCustodyStatusChangeId(), ps, 11);
        	            }
