...
<xsl:stylesheet version="2.0"
	...
	<xsl:import href="_maine-vehicle-crash-codes.xsl" />
		...
		<div>
			<table style="width:100%">
				<tr>
					...
					<td>
						<xsl:call-template name="formatLawEnforcementPresentAtWorkZone">
							<xsl:with-param name="LawEnforcementPresentAtWorkZoneCode"
								select="me-crash-codes:LawEnforcementPresentAtWorkZoneCode" />
						</xsl:call-template>
					</td>
				</tr>
				<tr>
					...
					<td>
						<xsl:call-template name="formatWorkZoneWorkersPresent">
							<xsl:with-param name="WorkZoneWorkersPresentCode"
								select="me-crash-codes:WorkZoneWorkersPresentCode" />
						</xsl:call-template>
					</td>
				</tr>
			</table>
		...
		<div>
			<table style="width:100%">
				<tr>
					...
					<td>
						<xsl:value-of
							select="ancestor::vcq-res-ext:VehicleCrashReport/nc:Vehicle[@structures:id=$vehicleId]/j:VehicleMakeCode"></xsl:value-of>
					</td>
				...
				<tr>
					...
					<td>
						<xsl:value-of
							select="ancestor::vcq-res-ext:VehicleCrashReport/nc:Vehicle[@structures:id=$vehicleId]/j:ConveyanceColorPrimaryCode" />
					</td>
				...
				<tr>
					...
					<td>
						<xsl:apply-templates
							select="ancestor::vcq-res-doc:VehicleCrashQueryResults/vcq-res-ext:VehicleCrashReport/j:Crash/j:CrashVehicle/vcq-res-ext:HitRunIndicator"
							mode="formatBooleanAsYesNo" />
					</td>
					<td class="detailsLabel">Extent of Damage</td>
					<td>
						<xsl:call-template name="formatVehicleDamageExtent">
							<xsl:with-param name="VehicleDamageExtentCode"
								select="me-crash-codes:VehicleDamageExtentCode" />
						</xsl:call-template>
					</td>
				</tr>
				<tr>
					...
					<td>
						<xsl:call-template name="formatPostedSpeedLimit">
							<xsl:with-param name="PostedSpeedLimitCode"
								select="me-crash-codes:PostedSpeedLimitCode" />
						</xsl:call-template>
					</td>
				...
				<tr>
					...
					<td>
						<xsl:value-of
							select="ancestor::vcq-res-ext:VehicleCrashReport/nc:Vehicle[@structures:id=$vehicleId]/nc:VehicleGrossLadenUnitWeightMeasure/nc:MeasureValueText" />
					</td>
				</tr>
				<tr>
					...
					<td>
						<xsl:value-of
							select="ancestor::vcq-res-ext:VehicleCrashReport/j:CrashDriverLicense[@structures:id=$driverLicenseId]/j:DriverLicenseCardIdentification/nc:IdentificationID" />
					</td>
				</tr>
				<tr>
					<td class="detailsLabel">Alcohol Test Type</td>
					<td>
						<xsl:call-template name="formatAlcoholTestCategory">
							<xsl:with-param name="AlcoholTestCategoryCode"
								select="ancestor::vcq-res-ext:VehicleCrashReport/nc:Person[@structures:id=$driverId]/me-crash-codes:AlcoholTestCategoryCode" />
						</xsl:call-template>
					</td>
				...
				<tr>
					...
					<td>
						<xsl:call-template name="formatDrugTestCategory">
							<xsl:with-param name="DrugTestCategoryCode"
								select="ancestor::vcq-res-ext:VehicleCrashReport/nc:Person[@structures:id=$driverId]/me-crash-codes:DrugTestCategoryCode" />
						</xsl:call-template>
					</td>
					<td class="detailsLabel">Drug Test Result </td>
					<td>
						<xsl:call-template name="formatDrugTestResult">
							<xsl:with-param name="DrugTestResultCode"
								select="ancestor::vcq-res-ext:VehicleCrashReport/nc:Person[@structures:id=$driverId]/me-crash-codes:DrugTestResultCode" />
						</xsl:call-template>
					</td>
				</tr>
				<tr>
					...
					<td>
						<xsl:call-template name="formatCrashSchoolBusRelated">
							<xsl:with-param name="CrashSchoolBusRelatedCode"
								select="ancestor::vcq-res-ext:VehicleCrashReport/j:Crash/j:CrashSchoolBusRelatedCode" />
						</xsl:call-template>
					</td>
				</tr>
			</table>
