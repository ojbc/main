...
public class VehicleCrashSubscriptionValidatorTest {
	
	private VehicleCrashSubscriptionValidator validator = new VehicleCrashSubscriptionValidator();
	...
	public void testValidatorSuccesses(){
		...
		subscription.setTopic("{http://ojbc.org/wsn/topics}:person/vehicleCrash");		
