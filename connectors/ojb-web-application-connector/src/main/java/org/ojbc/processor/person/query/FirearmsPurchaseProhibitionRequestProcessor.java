...
@Service
public class FirearmsPurchaseProhibitionRequestProcessor extends RequestResponseProcessor implements CamelContextAware, DetailsQueryInterface {
	...
	private MessageProcessor firearmsPurchaseProhibitionMessageProcessor;
	
	private OJBSamlMap OJBSamlMap;
	
	private boolean allowQueriesWithoutSAMLToken;
	
	private static final Log log = LogFactory.getLog( FirearmsPurchaseProhibitionRequestProcessor.class );
	
	public String invokeRequest(DetailsRequest firearmsPurchaseProhibitionRequest, String federatedQueryID, Element samlToken) throws Exception
	{
		...
		//POJO to XML Request
		Document firearmsPurchaseProhibitionRequestPayload = RequestMessageBuilderUtilities.createfirearmsPurchaseProhibition(firearmsPurchaseProhibitionRequest);
		
		//Create exchange
		Exchange senderExchange = new DefaultExchange(camelContext, ExchangePattern.InOnly);
		
		//Set exchange body to XML Request message
		senderExchange.getIn().setBody(firearmsPurchaseProhibitionRequestPayload);
		...
		firearmsPurchaseProhibitionMessageProcessor.sendResponseMessage(camelContext, senderExchange);
	...
	public MessageProcessor getFirearmsPurchaseProhibitionMessageProcessor() {
		return firearmsPurchaseProhibitionMessageProcessor;
	}


	public void setFirearmsPurchaseProhibitionMessageProcessor(
			MessageProcessor firearmsPurchaseProhibitionMessageProcessor) {
		this.firearmsPurchaseProhibitionMessageProcessor = firearmsPurchaseProhibitionMessageProcessor;
	}
