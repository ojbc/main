...
@Service
public class RapbackSearchRequestProcessor extends RequestResponseProcessor implements CamelContextAware, RapbackSearchInterface {
	...
	private MessageProcessor rapbackSearchMessageProcessor;
	...
	public String invokeRapbackSearchRequest(IdentificationResultSearchRequest searchRequest, Element samlToken) throws Exception
	{
		...
		rapbackSearchMessageProcessor.sendResponseMessage(camelContext, senderExchange);
	...
	public MessageProcessor getRapbackSearchMessageProcessor() {
		return rapbackSearchMessageProcessor;
	}


	public void setRapbackSearchMessageProcessor(
			MessageProcessor rapbackSearchMessageProcessor) {
		this.rapbackSearchMessageProcessor = rapbackSearchMessageProcessor;
	}
