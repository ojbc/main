...
public class ArrestReferralRequestProcessor extends RequestResponseProcessor implements CamelContextAware{
	private static final Log log = LogFactory.getLog( ArrestReferralRequestProcessor.class );
	/**
	...
	public String invokeRequest(ArrestReferral arrestReferral, Element samlToken) throws Throwable {
		if (samlToken == null)
		{
		...
		//POJO to XML Request
		Document requestPayload = RequestMessageBuilderUtilities.createArrestReferralRequest(arrestReferral);
