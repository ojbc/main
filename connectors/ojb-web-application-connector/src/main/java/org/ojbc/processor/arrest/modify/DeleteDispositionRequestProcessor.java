...
public class DeleteDispositionRequestProcessor extends RequestResponseProcessor implements CamelContextAware{
	...
	public String invokeRequest(Disposition disposition, Element samlToken) throws Throwable {
		...
		//POJO to XML Request
		Document arrestModifyRequestPayload = RequestMessageBuilderUtilities.createDeleteDispositionRequest(disposition);
