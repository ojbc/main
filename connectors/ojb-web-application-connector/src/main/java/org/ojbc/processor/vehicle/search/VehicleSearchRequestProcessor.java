 ...
 */
package org.ojbc.processor.vehicle.search;
...
/**
 * The class will handle vehicle search requests and responses
 * 
 * @author yogeshchawla
 *
 */
public class VehicleSearchRequestProcessor extends RequestResponseProcessor implements CamelContextAware, VehicleSearchInterface {
	...
	private MessageProcessor vehicleSearchMessageProcessor;
	
	private OJBSamlMap OJBSamlMap;
	
	private static final Log log = LogFactory.getLog( VehicleSearchRequestProcessor.class );
	...
	public String invokeVehicleSearchRequest(
		...
		//POJO to XML Request
		Document personSearchRequestPayload = RequestMessageBuilderUtilities.createVehicleSearchRequest(vehicleSearchRequest);
	...
	public MessageProcessor getVehicleSearchMessageProcessor() {
		return vehicleSearchMessageProcessor;
	}

	public void setVehicleSearchMessageProcessor(
			MessageProcessor vehicleSearchMessageProcessor) {
		this.vehicleSearchMessageProcessor = vehicleSearchMessageProcessor;
	}
