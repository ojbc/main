...
@Service
public class CannabisLicensingRequestProcessor extends RequestResponseProcessor implements CamelContextAware, DetailsQueryInterface {
	...
	private MessageProcessor cannabisLicensingMessageProcessor;
	
	private OJBSamlMap OJBSamlMap;
	
	private boolean allowQueriesWithoutSAMLToken;
	
	private static final Log log = LogFactory.getLog( CannabisLicensingRequestProcessor.class );
	...
	public String invokeRequest(DetailsRequest professionalLicensing, String federatedQueryID, Element samlToken) throws Exception
	{
		...
		//POJO to XML Request
		String professionalRequest = RequestMessageBuilderUtilities.createCannabisLicenseProfessionalRequest(professionalLicensing);
		...
		cannabisLicensingMessageProcessor.sendResponseMessage(camelContext, senderExchange);
	...
	public MessageProcessor getCannabisLicensingMessageProcessor() {
		return cannabisLicensingMessageProcessor;
	}

	public void setCannabisLicensingMessageProcessor(MessageProcessor cannabisLicensingMessageProcessor) {
		this.cannabisLicensingMessageProcessor = cannabisLicensingMessageProcessor;
	}
