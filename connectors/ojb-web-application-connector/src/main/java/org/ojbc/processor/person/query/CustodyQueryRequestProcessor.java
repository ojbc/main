...
@Service
public class CustodyQueryRequestProcessor extends RequestResponseProcessor implements CamelContextAware, DetailsQueryInterface {
	...
	private MessageProcessor custodyQueryRequestMessageProcessor;
	
	private OJBSamlMap OJBSamlMap;
	
	private boolean allowQueriesWithoutSAMLToken;
	
	private static final Log log = LogFactory.getLog( CustodyQueryRequestProcessor.class );
	
	public String invokeRequest(DetailsRequest custodyQueryRequest, String federatedQueryID, Element samlToken) throws Exception
	{
		...
		log.debug("Custody ID from web portal: "  + custodyQueryRequest.getIdentificationID());
		log.debug("Custody Source Text from web portal: "  + custodyQueryRequest.getIdentificationSourceText());
		
		//POJO to XML Request
		String requestPayload = RequestMessageBuilderUtilities.createCustodyQueryRequest(custodyQueryRequest.getIdentificationID(), custodyQueryRequest.getIdentificationSourceText());
		...
		custodyQueryRequestMessageProcessor.sendResponseMessage(camelContext, senderExchange);
	...
	public MessageProcessor getCustodyQueryRequestMessageProcessor() {
		return custodyQueryRequestMessageProcessor;
	}


	public void setCustodyQueryRequestMessageProcessor(
			MessageProcessor custodyQueryRequestMessageProcessor) {
		this.custodyQueryRequestMessageProcessor = custodyQueryRequestMessageProcessor;
	}
