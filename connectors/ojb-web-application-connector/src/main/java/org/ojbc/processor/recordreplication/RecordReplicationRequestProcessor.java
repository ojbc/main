 ...
 */
package org.ojbc.processor.recordreplication;
...
public class RecordReplicationRequestProcessor extends RequestResponseProcessor implements CamelContextAware{
	...
	public String invokeRequest(String otn, Element samlToken) throws Throwable {
		if (samlToken == null)
		{
		...
		//POJO to XML Request
		Document recordReplicationRequestPayload = RequestMessageBuilderUtilities.createRecordReplicationRequest(otn);
		
		//Create exchange
		Exchange senderExchange = new DefaultExchange(camelContext, ExchangePattern.InOnly);
		
		//Set exchange body to XML Request message
		senderExchange.getIn().setBody(recordReplicationRequestPayload);
