...
@Service
public class VehicleCrashQueryRequestProcessor extends RequestResponseProcessor implements CamelContextAware, DetailsQueryInterface {
	...
	private static final Log log = LogFactory.getLog( VehicleCrashQueryRequestProcessor.class );
	...
	public String invokeRequest(DetailsRequest detailRequest, String federatedQueryID, Element samlToken) throws Exception
	{
		...
		//POJO to XML Request
		String criminalHistoryRequestPayload = RequestMessageBuilderUtilities.createVehicleCrashQueryRequest(detailRequest);
