...
public class ChargeReferralRequestProcessor extends RequestResponseProcessor implements CamelContextAware{
	private static final Log log = LogFactory.getLog( ChargeReferralRequestProcessor.class );
	/**
	...
	public String invokeRequest(ChargeReferral chargeReferral, Element samlToken) throws Throwable {
		if (samlToken == null)
		{
		...
		//POJO to XML Request
		Document requestPayload = RequestMessageBuilderUtilities.createChargeReferralRequest(chargeReferral);
