...
@Service
public class FBICriminalHistoryRequestProcessor extends RequestResponseProcessor implements CamelContextAware, DetailsQueryInterface {
	...
	private static final Log log = LogFactory.getLog( FBICriminalHistoryRequestProcessor.class );
	...
	public String invokeRequest(DetailsRequest criminalHistoryRequest, String federatedQueryID, Element samlToken) throws Exception
	{
		...
		//POJO to XML Request
		Document criminalHistoryRequestPayload = RequestMessageBuilderUtilities.createFbiPersonQueryRequest(criminalHistoryRequest);
