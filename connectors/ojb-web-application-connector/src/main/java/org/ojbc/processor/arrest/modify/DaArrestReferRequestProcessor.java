...
public class DaArrestReferRequestProcessor extends RequestResponseProcessor implements CamelContextAware{
	...
	public String invokeRequest(String id, Element samlToken) throws Throwable {
		...
		senderExchange.getIn().setBody(arrestHideRequestPayload);
