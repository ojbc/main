 ...
 */
package org.ojbc.processor.policy.acknowledge;
...
public class PolicyAcknowledgmentRecordingRequestProcessor extends RequestResponseProcessor
        implements CamelContextAware, PolicyBasedAcknowledgementRecordingService {
    ...
    private final Log log = LogFactory.getLog(PolicyAcknowledgmentRecordingRequestProcessor.class);
