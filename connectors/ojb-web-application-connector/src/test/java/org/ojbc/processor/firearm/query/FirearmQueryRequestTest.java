...
public class FirearmQueryRequestTest {
	...
	public void testRequestForFirearmMaui() throws Exception{
		...
		XmlUtils.validateInstance("ssp/Firearm_Registration_Query_Request/artifacts/service_model/information_model/IEPD_IEPD/xsd", "Subset/niem", "exchange_schema.xsd",resultingDoc);
