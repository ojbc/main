...
public class FirearmQueryRequestTest {
	...
	public void testRequestForFirearmMaui() throws Exception{
		...
		XmlUtils.validateInstance("ssp/Firearm_Registration_Query_Request/artifacts/service_model/information_model/Firearm_Registration_Query_Request_IEPD/xsd", "Subset/niem", "exchange_schema.xsd",resultingDoc);
