...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:xs="http://www.w3.org/2001/XMLSchema"
	...
	xmlns:j50="http://release.niem.gov/niem/domains/jxdm/5.0/" xmlns:nc30="http://release.niem.gov/niem/niem-core/3.0/"
	xmlns:niem-xs="http://release.niem.gov/niem/proxy/xsd/3.0/" xmlns:s30="http://release.niem.gov/niem/structures/3.0/"
	...
	<xsl:param name="systemIdCourtDisposition">
			...
			<b:NotificationMessage>
				...
				<b:Message>
					<notification:NotificationMessage>
						...
						<xsl:apply-templates select="j50:PersonChargeAssociation" mode="person-charge" />
						<xsl:apply-templates select="j50:ActivityChargeAssociation" mode="activity-charge" />
						<xsl:apply-templates select="cdr-report-ext:ChargeDispositionAssociation" mode="charge-disposition" />
					</notification:NotificationMessage>
				</b:Message>
			</b:NotificationMessage>
		</b:Notify>
	...
	<xsl:template match="j50:Charge">
		<j:Charge>
			<xsl:attribute name="s:id"><xsl:value-of select="./@s30:id" /></xsl:attribute>
	...
	<xsl:template match="j50:PersonChargeAssociation" mode="person-charge">
		<j:PersonChargeAssociation>
			<nc:PersonReference>
				<xsl:attribute name="s:ref"><xsl:value-of select="/cdr-report-doc:CourtDispositionRecordingReport/nc30:Person/@s30:id" /></xsl:attribute>
			</nc:PersonReference>
			<j:ChargeReference>
				<xsl:attribute name="s:ref"><xsl:value-of select="./j50:Charge/@s30:ref" /></xsl:attribute>
			</j:ChargeReference>
		</j:PersonChargeAssociation>
	</xsl:template>
	<xsl:template match="j50:ActivityChargeAssociation" mode="activity-charge">
		<j:ActivityChargeAssociation>
			<nc:ActivityReference>
				<xsl:attribute name="s:ref"><xsl:value-of select="./nc30:Activity/@s30:ref" /></xsl:attribute>
			</nc:ActivityReference>
			<j:ChargeReference>
				<xsl:attribute name="s:ref"><xsl:value-of select="./j50:Charge/@s30:ref" /></xsl:attribute>
			</j:ChargeReference>
	...
	<xsl:template match="cdr-report-ext:ChargeDispositionAssociation" mode="charge-disposition">
		<notification:ChargeDispositionAssociation>
			<j:ChargeReference>
				<xsl:attribute name="s:ref"><xsl:value-of select="./j50:Charge/@s30:ref" /></xsl:attribute>
			</j:ChargeReference>
			<j:DispositionReference>
				<xsl:attribute name="s:ref"><xsl:value-of select="./nc30:Disposition/@s30:ref" /></xsl:attribute>
			</j:DispositionReference>
		</notification:ChargeDispositionAssociation>
	</xsl:template>
	<xsl:template match="nc30:RoleOfPerson" mode="activityInvolvedPerson">
		...
		<nc:ActivityInvolvedPersonAssociation>
			...
			<nc:PersonReference>
				<xsl:attribute name="s:ref">
					<xsl:value-of
					select="/cdr-report-doc:CourtDispositionRecordingReport/nc30:Person/@s30:id" />
				</xsl:attribute>
			</nc:PersonReference>
		</nc:ActivityInvolvedPersonAssociation>
	</xsl:template>
	<xsl:template match="nc30:Person" mode="person">
		...
		<j:Person>
			...
			<xsl:apply-templates
				select="j50:PersonAugmentation/j50:PersonStateFingerprintIdentification/nc30:IdentificationID" mode="sid" />
		</j:Person>
	</xsl:template>
