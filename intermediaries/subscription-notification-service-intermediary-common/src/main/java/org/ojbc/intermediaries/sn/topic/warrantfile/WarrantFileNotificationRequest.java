...
public class WarrantFileNotificationRequest extends NotificationRequest{
	...
	protected String getNotifyingSystemNameXPath(){
		return "/b-2:Notify/b-2:NotificationMessage/b-2:Message/notfm-exch:NotificationMessage/notfm-ext:NotifyingWarrant/notfm-ext:NotifyingActivityReportingSystemNameText";
	}
