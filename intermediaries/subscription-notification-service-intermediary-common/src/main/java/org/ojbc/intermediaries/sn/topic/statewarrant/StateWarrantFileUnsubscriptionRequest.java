...
public class StateWarrantFileUnsubscriptionRequest extends UnSubscriptionRequest{
	public StateWarrantFileUnsubscriptionRequest(Message message) throws Exception{
		super(message);
	...
	public StateWarrantFileUnsubscriptionRequest(String topic, List<String> emailAddresses, String systemName, String subscriptionQualifier, 
