 ...
 *
 */
public class StateMapEmailEnhancementStrategy implements EmailEnhancementStrategy {
	
	private EmailEnhancementStrategy defaultStrategy = new DefaultEmailEnhancementStrategy();
	
	private Map<String, EmailEnhancementStrategy> stateStrategyMap = new HashMap<String, EmailEnhancementStrategy>();
	...
	public Map<String, EmailEnhancementStrategy> getStateStrategyMap() {
		return stateStrategyMap;
	}

	public void setStateStrategyMap(Map<String, EmailEnhancementStrategy> stateStrategyMap) {
		this.stateStrategyMap = stateStrategyMap;
	}

	@Override
	public EmailNotification enhanceEmail(EmailNotification emailNotification) {
		EmailEnhancementStrategy strategy = stateStrategyMap.get(emailNotification.getSubscription().getState());
		if (strategy == null) {
