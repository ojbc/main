...
public class VehicleCrashUnSubscriptionRequest extends UnSubscriptionRequest {

	public VehicleCrashUnSubscriptionRequest(Message message) throws Exception{
		super(message);
	...
	public VehicleCrashUnSubscriptionRequest(String topic, List<String> emailAddresses, String systemName, String subscriptionQualifier, 
