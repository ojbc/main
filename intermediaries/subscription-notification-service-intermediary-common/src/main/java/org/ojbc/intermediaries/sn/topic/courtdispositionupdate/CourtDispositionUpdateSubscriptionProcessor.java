...
public class CourtDispositionUpdateSubscriptionProcessor extends SubscriptionProcessor {
	...
	public SubscriptionRequest makeSubscriptionRequestFromIncomingMessage(
		...
		CourtDispositionUpdateSubscriptionRequest courtDispositionUpdateSubscriptionRequest = new CourtDispositionUpdateSubscriptionRequest(msg,allowedEmailAddressPatterns);
		
		Map<String, String> allowedSubjectIdentifiers = courtDispositionUpdateSubscriptionRequest.getSubjectIdentifiers();
		...
		courtDispositionUpdateSubscriptionRequest.setSubjectIdentifiers(finalSubjectIdentifiers);
		
		return courtDispositionUpdateSubscriptionRequest;
	}
	...
	public UnSubscriptionRequest makeUnSubscriptionRequestFromIncomingMessage(
		...
		UnSubscriptionRequest unSubscriptionRequest = new CourtDispositionUpdateUnSubscriptionRequest(msg);
	...
	protected String getTopic() {
		...
		return "{http://ojbc.org/wsn/topics}:person/CourtDispositionUpdate";
	}
