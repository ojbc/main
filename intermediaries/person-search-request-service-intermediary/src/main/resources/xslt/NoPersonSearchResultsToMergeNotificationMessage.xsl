...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:template match="/">
    	<EntityMergeResultMessage xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance"
    	 xmlns="http://nij.gov/IEPD/Exchange/EntityMergeResultMessage/1.0">
    	    <EntityResolutionPerformedIndicator>false</EntityResolutionPerformedIndicator>
