...
<xsl:stylesheet version="2.0" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance"
	xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:ansi-nist="http://niem.gov/niem/biometrics/1.0"
	xmlns:nc20="http://niem.gov/niem/niem-core/2.0" xmlns:nc30="http://release.niem.gov/niem/niem-core/3.0/"
	xmlns:arrest-exch="http://ojbc.org/IEPD/Exchange/ArrestReport/1.0" xmlns:lexs="http://usdoj.gov/leisp/lexs/3.1"
	xmlns:lexspd="http://usdoj.gov/leisp/lexs/publishdiscover/3.1" xmlns:lexsdigest="http://usdoj.gov/leisp/lexs/digest/3.1"
	xmlns:s="http://niem.gov/niem/structures/2.0" xmlns:lexslib="http://usdoj.gov/leisp/lexs/library/3.1"
	xmlns:ojbc="http://ojbc.org/IEPD/Extensions/ArrestReportStructuredPayload/1.0" xmlns:j40="http://niem.gov/niem/domains/jxdm/4.0"
	xmlns:j41="http://niem.gov/niem/domains/jxdm/4.1" xmlns:j50="http://release.niem.gov/niem/domains/jxdm/5.0/"
	...
	<xsl:variable name="currentDateTimeString"
				...
				<lexs:PublishMessage>
					...
					<lexs:DataItemPackage>
						<lexs:PackageMetadata>
							<lexs:DataOwnerMetadata>
								<lexs:DataOwnerIdentifier>
									<xsl:apply-templates
										select="ident-ext:IdentificationApplicantOrganization/j50:OrganizationAugmentation/j50:OrganizationORIIdentification/nc30:IdentificationID"
										mode="ORI" />
								</lexs:DataOwnerIdentifier>
							</lexs:DataOwnerMetadata>
						</lexs:PackageMetadata>
						...
						<lexs:StructuredPayload>
							...
							<ojbc:ArrestReport>
								<xsl:apply-templates
									select="j50:Subject/nc30:RoleOfPerson/ident-ext:PersonTrackingIdentification/nc30:IdentificationID"
									mode="structuredPayload-OTN" />
								<xsl:apply-templates
									select="j50:Subject/nc30:RoleOfPerson/j50:PersonAugmentation/j50:PersonStateFingerprintIdentification"
									mode="structuredPayload" />
							</ojbc:ArrestReport>
						</lexs:StructuredPayload>
					</lexs:DataItemPackage>
				</lexs:PublishMessage>
	...
	<xsl:template match="nc30:IdentificationID" mode="structuredPayload-OTN">
		<ojbc:Person>
