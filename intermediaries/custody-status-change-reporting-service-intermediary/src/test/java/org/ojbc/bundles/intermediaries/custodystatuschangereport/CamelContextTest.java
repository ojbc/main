 ...
 */
package org.ojbc.bundles.intermediaries.custodystatuschangereport;
...
public class CamelContextTest {
    ...
    @EndpointInject(uri = "mock:log:org.ojbc.bundles.intermediaries.custodystatuschangereport")
	...
	public void setUp() throws Exception {
    	...
    	context.getRouteDefinition("custodyStatusChangeReporting_route").adviceWith(context, new AdviceWithRouteBuilder() {
    	    @Override
    	    public void configure() throws Exception {
    	    	// The line below allows us to bypass CXF and send a message directly into the route
    	    	replaceFromWith("direct:CustodyStatusChageReportingRouteMockEntry");
    	    	mockEndpoints("log:org.ojbc.bundles.intermediaries.custodystatuschangereport*");    	    	
    	    }              
    	});
	...
	public void testContextRoutes() throws Exception{
		...
		Exchange returnExchange = template.send("direct:CustodyStatusChageReportingRouteMockEntry", senderExchange);
