...
public class MergeNotificationMaxRecordProcessor {
	...
	public String returnMergeNotificationErrorMessageTooManyRecords(Document resultsDocument, @Header("firearmsSearchMaxRecords") String maxRecords) throws Exception
	{
		...
		for (String systemName : federatedQueryEndpointMap.keySet()) {
		    String count = XmlUtils.xPathStringSearch(resultsDocument, "count(/OJBAggregateResponseWrapper/firearm-search-resp-doc:FirearmSearchResults/firearm-search-resp-ext:FirearmSearchResult[normalize-space(firearm-search-resp-ext:SourceSystemNameText)='" + systemName + "'])");
		    
		    String systemDisplayName = "";
		    
		    if (Integer.valueOf(count) > 0 )
		    {
		    	systemDisplayName = XmlUtils.xPathStringSearch(resultsDocument, "/OJBAggregateResponseWrapper/firearm-search-resp-doc:FirearmSearchResults/firearm-search-resp-ext:FirearmSearchResult[normalize-space(firearm-search-resp-ext:SourceSystemNameText)='" + systemName + "'][1]/intel:SystemIdentifier/intel:SystemName");
		    }	
