...
public class CaseFilingDecisionReportingTransformerServiceTest {
			
	private XsltTransformer xsltTransformer;
	
	private static final Log log = LogFactory.getLog(CaseFilingDecisionReportingTransformerServiceTest.class);
	...
	@Test
	public void caseFilingDecisionReportTest() throws Exception{		
		
		DetailedDiff detailedDiff = runTransform("src/test/resources/xmlInstances/caseFilingDecisionReport/AK-CaseFilingDecisionReport.xml",
				"src/main/resources/xslt/caseFilingDecisionReportToCriminalCaseFiling.xsl",
				"src/test/resources/xmlInstances/output/criminalCaseFiling/AK-CriminalCaseFiling.xml");
